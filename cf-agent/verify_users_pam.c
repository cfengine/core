...
static bool GetGroupInfo (const char *user, User u, StringSet **groups_to_set, StringSet **groups_missing, StringSet **current_secondary_groups)
{
    bool ret = true;
...
static bool DoModifyUser (const char *puser, User u, const struct passwd *passwd_info, uint32_t changemap, enum cfopaction action, StringSet *groups_to_set)
{
    char cmd[CF_BUFSIZE];
