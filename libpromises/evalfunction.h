...
FnCallResult FnCallHostInNetgroup(EvalContext *ctx, const Policy *policy, FnCall *fp, Rlist *finalargs);
...
FnCallResult FnCallGroupExists(EvalContext *ctx, const Policy *policy, FnCall *fp, Rlist *finalargs);
FnCallResult FnCallUserExists(EvalContext *ctx, const Policy *policy, FnCall *fp, Rlist *finalargs);
