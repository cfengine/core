                                        ...
                                        ARG_UNUSED void *param)
{
    ...
    else if (strcmp("build_xpath", pp->parent_section->name) == 0)
    {
    ...
    else if (strcmp("delete_tree", pp->parent_section->name) == 0)
    {
    ...
    else if (strcmp("insert_tree", pp->parent_section->name) == 0)
    {
        Attributes a = GetInsertionAttributes(ctx, pp);
#ifdef HAVE_LIBXML2
        EditContext *edcontext = param;
    ...
    else if (strcmp("delete_attribute", pp->parent_section->name) == 0)
    {
        Attributes a = GetDeletionAttributes(ctx, pp);
#ifdef HAVE_LIBXML2
        EditContext *edcontext = param;
    ...
    else if (strcmp("set_attribute", pp->parent_section->name) == 0)
    {
        Attributes a = GetInsertionAttributes(ctx, pp);
#ifdef HAVE_LIBXML2
        EditContext *edcontext = param;
    ...
    else if (strcmp("delete_text", pp->parent_section->name) == 0)
    {
        Attributes a = GetDeletionAttributes(ctx, pp);
#ifdef HAVE_LIBXML2
        EditContext *edcontext = param;
    ...
    else if (strcmp("set_text", pp->parent_section->name) == 0)
    {
        Attributes a = GetInsertionAttributes(ctx, pp);
#ifdef HAVE_LIBXML2
        EditContext *edcontext = param;
    ...
    else if (strcmp("insert_text", pp->parent_section->name) == 0)
    {
        Attributes a = GetInsertionAttributes(ctx, pp);
#ifdef HAVE_LIBXML2
        EditContext *edcontext = param;
...
static bool SanityCheckXPathBuild(EvalContext *ctx, const Attributes *a, const Promise *pp, PromiseResult *result)
{
    ...
    if ((strcmp("build_xpath", pp->parent_section->name) == 0) && (a->xml.havebuildxpath))
    {
