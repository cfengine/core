...
const char *OBS[CF_OBSERVABLES][2] =
{
    ...
    {"www_alt_out", "Alternative web service connections (out)"},
    {"imaps_in", "encrypted imap mail client sessions (in)"},
    {"imaps_out", "encrypted imap mail client sessions (out)"},
    {"ldap_in", "LDAP directory service client sessions (in)"},
    {"ldap_out", "LDAP directory service client sessions (out)"},
    {"ldaps_in", "LDAP directory service client sessions (in)"},
