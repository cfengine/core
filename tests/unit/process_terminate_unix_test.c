...
void test_kill_simple_process(void **state)
{
    InitTime();
...
void test_kill_wrong_process(void **state)
{
    InitTime();
...
void test_kill_long_reacting_signal(void **state)
{
...
void test_kill_no_sigint(void **state)
{
...
void test_kill_no_sigint_sigterm(void **state)
{
...
void test_kill_anothers_process(void **state)
{
