...
#define FnCallTypeNew(name, return_type, arguments, implementation, description, is_varargs) { name, return_type, arguments, implementation, description, is_varargs }
#define FnCallTypeNewNull() FnCallTypeNew(NULL, DATA_TYPE_NONE, NULL, NULL, NULL, false)
