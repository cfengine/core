...
{
#ifdef PRIVATE_DEBUG
Log(LOG_LEVEL_WARNING, "RestoreGlobalLogLevels()");
#endif
...
{
#ifdef PRIVATE_DEBUG
Log(LOG_LEVEL_WARNING, "HonorReportLevel() Changing log levels based on log_level and report_level for promiser '%s'", pp->promiser);
#endif
