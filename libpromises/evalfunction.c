...
{
    {CF_ANYSTRING, CF_DATA_TYPE_STRING, "Group name or group ID in text"},
    {NULL, CF_DATA_TYPE_NONE, NULL}
};
...
const FnCallType CF_FNCALL_TYPES[] =
{
    ...
    FnCallTypeNew("classfilterdata", CF_DATA_TYPE_CONTAINER, CLASSFILTERDATA_ARGS, &FnCallClassFilterData, "Filter data container by defined classes",
                  FNCALL_OPTION_COLLECTING | FNCALL_OPTION_VARARG, FNCALL_CATEGORY_IO, SYNTAX_STATUS_NORMAL),
    ...
    FnCallTypeNew("getgroupinfo", CF_DATA_TYPE_CONTAINER, GETGROUPINFO_ARGS, &FnCallGetGroupInfo, "Get a data container describing group arg1, defaulting to current group",
                  FNCALL_OPTION_VARARG, FNCALL_CATEGORY_SYSTEM, SYNTAX_STATUS_NORMAL),
