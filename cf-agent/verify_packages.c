...
static int PackageSanityCheck(EvalContext *ctx, Attributes a, const Promise *pp)
{
    ...
    {
        cfPS(ctx, LOG_LEVEL_ERR, PROMISE_RESULT_FAIL, pp, a, "!! Package installed regex undefined");
        return false;
    }
...
/* Now we need to know the name-convention expected by the package manager */
    ...
    case PACKAGE_ACTION_ADD:
        ...
        if (installed == 0)
        {
            ...
            {
                cfPS(ctx, LOG_LEVEL_ERR, PROMISE_RESULT_FAIL, pp, a, "Package add command undefined");
    ...
    case PACKAGE_ACTION_DELETE:
            ...
            (installed && no_version_specified))
        {
            ...
            {
                cfPS(ctx, LOG_LEVEL_ERR, PROMISE_RESULT_FAIL, pp, a, "Package delete command undefined");
                BufferDestroy(expanded);
                return PROMISE_RESULT_FAIL;
            }
