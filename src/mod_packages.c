...
struct BodySyntax CF_PKGMETHOD_BODY[] =
   ...
   {"package_delete_convention",cf_str,"","This is how the package manager expects the file to be referred to during deletion of a package, e.g. $(name).$(arch)"},
   ...
   {"package_name_convention",cf_str,"","This is how the package manager expects the file to be referred to during addition of a package, e.g. $(name).$(arch)"},
