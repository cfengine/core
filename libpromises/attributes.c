...
// default for file copy
    ...
    attr.template = (char *)GetConstraintValue("edit_template", pp, RVAL_TYPE_SCALAR);
...
/* Files, specialist */
    ...
    attr.repository = (char *) GetConstraintValue("repository", pp, RVAL_TYPE_SCALAR);
    attr.create = GetBooleanConstraint("create", pp);
    attr.touch = GetBooleanConstraint("touch", pp);
    attr.transformer = (char *) GetConstraintValue("transformer", pp, RVAL_TYPE_SCALAR);
    attr.move_obstructions = GetBooleanConstraint("move_obstructions", pp);
    attr.pathtype = (char *) GetConstraintValue("pathtype", pp, RVAL_TYPE_SCALAR);
...
Attributes GetOutputsAttributes(const Promise *pp)
{
    ...
    attr.output.promiser_type = GetConstraintValue("promiser_type", pp, RVAL_TYPE_SCALAR);
    attr.output.level = GetConstraintValue("output_level", pp, RVAL_TYPE_SCALAR);
    return attr;
}
...
Attributes GetExecAttributes(const Promise *pp)
{
    ...
    attr.args = GetConstraintValue("args", pp, RVAL_TYPE_SCALAR);
...
Attributes GetProcessAttributes(const Promise *pp)
{
    ...
    attr.process_stop = (char *) GetConstraintValue("process_stop", pp, RVAL_TYPE_SCALAR);
    attr.haveprocess_count = GetBooleanConstraint("process_count", pp);
    attr.haveselect = GetBooleanConstraint("process_select", pp);
    attr.restart_class = (char *) GetConstraintValue("restart_class", pp, RVAL_TYPE_SCALAR);
...
Attributes GetTopicsAttributes(const Promise *pp)
{
    ...
    attr.fwd_name = GetConstraintValue("forward_relationship", pp, RVAL_TYPE_SCALAR);
    attr.bwd_name = GetConstraintValue("backward_relationship", pp, RVAL_TYPE_SCALAR);
...
Attributes GetOccurrenceAttributes(const Promise *pp)
{
    ...
    attr.rep_type = GetConstraintValue("representation", pp, RVAL_TYPE_SCALAR);
...
Services GetServicesConstraints(const Promise *pp)
{
    ...
    s.service_type = GetConstraintValue("service_type", pp, RVAL_TYPE_SCALAR);
    s.service_policy = Str2ServicePolicy(GetConstraintValue("service_policy", pp, RVAL_TYPE_SCALAR));
    s.service_autostart_policy = GetConstraintValue("service_autostart_policy", pp, RVAL_TYPE_SCALAR);
    s.service_args = GetConstraintValue("service_args", pp, RVAL_TYPE_SCALAR);
    s.service_depend = GetListConstraint("service_dependencies", pp);
    s.service_depend_chain = GetConstraintValue("service_dependence_chain", pp, RVAL_TYPE_SCALAR);
...
Environments GetEnvironmentsConstraints(const Promise *pp)
{
    ...
    e.baseline = GetConstraintValue("env_baseline", pp, RVAL_TYPE_SCALAR);
    e.spec = GetConstraintValue("env_spec", pp, RVAL_TYPE_SCALAR);
    e.host = GetConstraintValue("environment_host", pp, RVAL_TYPE_SCALAR);

    e.addresses = GetListConstraint("env_addresses", pp);
    e.name = GetConstraintValue("env_name", pp, RVAL_TYPE_SCALAR);
    e.type = GetConstraintValue("environment_type", pp, RVAL_TYPE_SCALAR);
    e.state = Str2EnvState(GetConstraintValue("environment_state", pp, RVAL_TYPE_SCALAR));
...
ExecContain GetExecContainConstraints(const Promise *pp)
{
    ...
    e.chroot = GetConstraintValue("chroot", pp, RVAL_TYPE_SCALAR);
    e.chdir = GetConstraintValue("chdir", pp, RVAL_TYPE_SCALAR);
...
Acl GetAclConstraints(const Promise *pp)
{
    ...
    ac.acl_method = Str2AclMethod(GetConstraintValue("acl_method", pp, RVAL_TYPE_SCALAR));
    ac.acl_type = Str2AclType(GetConstraintValue("acl_type", pp, RVAL_TYPE_SCALAR));
    ac.acl_directory_inherit = Str2AclInherit(GetConstraintValue("acl_directory_inherit", pp, RVAL_TYPE_SCALAR));
...
FilePerms GetPermissionConstraints(const Promise *pp)
{
    ...
    value = (char *) GetConstraintValue("mode", pp, RVAL_TYPE_SCALAR);
...
#else /* !__MINGW32__ */
    p.owners = Rlist2UidList((Rlist *) GetConstraintValue("owners", pp, RVAL_TYPE_LIST), pp);
    p.groups = Rlist2GidList((Rlist *) GetConstraintValue("groups", pp, RVAL_TYPE_LIST), pp);
#endif /* !__MINGW32__ */

    p.findertype = (char *) GetConstraintValue("findertype", pp, RVAL_TYPE_SCALAR);
    p.rxdirs = GetBooleanConstraint("rxdirs", pp);

// The default should be true

    if (!GetConstraintValue("rxdirs", pp, RVAL_TYPE_SCALAR))
    {
        p.rxdirs = true;
    }
...
FileSelect GetSelectConstraints(const Promise *pp)
{
    ...
    s.name = (Rlist *) GetConstraintValue("leaf_name", pp, RVAL_TYPE_LIST);
    s.path = (Rlist *) GetConstraintValue("path_name", pp, RVAL_TYPE_LIST);
    s.filetypes = (Rlist *) GetConstraintValue("file_types", pp, RVAL_TYPE_LIST);
    s.issymlinkto = (Rlist *) GetConstraintValue("issymlinkto", pp, RVAL_TYPE_LIST);
    ...
    s.owners = (Rlist *) GetConstraintValue("search_owners", pp, RVAL_TYPE_LIST);
    s.groups = (Rlist *) GetConstraintValue("search_groups", pp, RVAL_TYPE_LIST);

    value = (char *) GetConstraintValue("search_size", pp, RVAL_TYPE_SCALAR);
    if (value)
    {
        entries++;
    }
    ...
    value = (char *) GetConstraintValue("ctime", pp, RVAL_TYPE_SCALAR);
    if (value)
    {
        entries++;
    }
    ...
    value = (char *) GetConstraintValue("atime", pp, RVAL_TYPE_SCALAR);
    if (value)
    {
        entries++;
    }
    IntRange2Int(value, (long *) &s.min_atime, (long *) &s.max_atime, pp);
    value = (char *) GetConstraintValue("mtime", pp, RVAL_TYPE_SCALAR);
    if (value)
    {
        entries++;
    }
    ...
    s.exec_regex = (char *) GetConstraintValue("exec_regex", pp, RVAL_TYPE_SCALAR);
    s.exec_program = (char *) GetConstraintValue("exec_program", pp, RVAL_TYPE_SCALAR);
    ...
    if ((s.result = (char *) GetConstraintValue("file_result", pp, RVAL_TYPE_SCALAR)) == NULL)
    {
        if (!entries)
        {
...
TransactionContext GetTransactionConstraints(const Promise *pp)
{
    ...
    value = GetConstraintValue("action_policy", pp, RVAL_TYPE_SCALAR);
    ...
    t.log_string = GetConstraintValue("log_string", pp, RVAL_TYPE_SCALAR);
    t.log_priority = SyslogPriority2Int(GetConstraintValue("log_priority", pp, RVAL_TYPE_SCALAR));

    t.log_kept = GetConstraintValue("log_kept", pp, RVAL_TYPE_SCALAR);
    t.log_repaired = GetConstraintValue("log_repaired", pp, RVAL_TYPE_SCALAR);
    t.log_failed = GetConstraintValue("log_failed", pp, RVAL_TYPE_SCALAR);
    ...
    value = GetConstraintValue("log_level", pp, RVAL_TYPE_SCALAR);
    t.log_level = String2ReportLevel(value);

    value = GetConstraintValue("report_level", pp, RVAL_TYPE_SCALAR);
    t.report_level = String2ReportLevel(value);

    t.measure_id = GetConstraintValue("measurement_class", pp, RVAL_TYPE_SCALAR);
...
DefineClasses GetClassDefinitionConstraints(const Promise *pp)
{
    ...
    pt = GetConstraintValue("timer_policy", pp, RVAL_TYPE_SCALAR);
...
FileDelete GetDeleteConstraints(const Promise *pp)
{
    ...
    value = (char *) GetConstraintValue("dirlinks", pp, RVAL_TYPE_SCALAR);
...
FileRename GetRenameConstraints(const Promise *pp)
{
    ...
    value = (char *) GetConstraintValue("disable_mode", pp, RVAL_TYPE_SCALAR);
    ...
    r.disable_suffix = (char *) GetConstraintValue("disable_suffix", pp, RVAL_TYPE_SCALAR);
    r.newname = (char *) GetConstraintValue("newname", pp, RVAL_TYPE_SCALAR);
...
FileChange GetChangeMgtConstraints(const Promise *pp)
{
    ...
    value = (char *) GetConstraintValue("hash", pp, RVAL_TYPE_SCALAR);
    ...
    if (GetConstraintValue("update_hashes", pp, RVAL_TYPE_SCALAR))
    {
...
FileCopy GetCopyConstraints(const Promise *pp)
{
    ...
    f.source = (char *) GetConstraintValue("source", pp, RVAL_TYPE_SCALAR);

    value = (char *) GetConstraintValue("compare", pp, RVAL_TYPE_SCALAR);
    ...
    value = (char *) GetConstraintValue("link_type", pp, RVAL_TYPE_SCALAR);
    ...
    value = (char *) GetConstraintValue("copy_backup", pp, RVAL_TYPE_SCALAR);
    ...
    value = (char *) GetConstraintValue("copy_size", pp, RVAL_TYPE_SCALAR);
...
FileLink GetLinkConstraints(const Promise *pp)
{
    ...
    value = (char *) GetConstraintValue("when_no_source", pp, RVAL_TYPE_SCALAR);
    ...
    value = (char *) GetConstraintValue("when_linking_children", pp, RVAL_TYPE_SCALAR);
...
EditDefaults GetEditDefaults(const Promise *pp)
{
    ...
    value = (char *) GetConstraintValue("edit_backup", pp, RVAL_TYPE_SCALAR);
...
Packages GetPackageConstraints(const Promise *pp)
{
    ...
    p.package_version = (char *) GetConstraintValue("package_version", pp, RVAL_TYPE_SCALAR);
    p.package_architectures = GetListConstraint("package_architectures", pp);

    action = Str2PackageAction((char *) GetConstraintValue("package_policy", pp, RVAL_TYPE_SCALAR));
    ...
    operator = Str2PackageSelect((char *) GetConstraintValue("package_select", pp, RVAL_TYPE_SCALAR));

    p.package_select = operator;
    change_policy = Str2ActionPolicy((char *) GetConstraintValue("package_changes", pp, RVAL_TYPE_SCALAR));
    p.package_changes = change_policy;

    p.package_file_repositories = GetListConstraint("package_file_repositories", pp);

    p.package_default_arch_command = (char *) GetConstraintValue("package_default_arch_command", pp, RVAL_TYPE_SCALAR);

    p.package_patch_list_command = (char *) GetConstraintValue("package_patch_list_command", pp, RVAL_TYPE_SCALAR);
    p.package_patch_name_regex = (char *) GetConstraintValue("package_patch_name_regex", pp, RVAL_TYPE_SCALAR);
    p.package_patch_arch_regex = (char *) GetConstraintValue("package_patch_arch_regex", pp, RVAL_TYPE_SCALAR);
    p.package_patch_version_regex = (char *) GetConstraintValue("package_patch_version_regex", pp, RVAL_TYPE_SCALAR);
    p.package_patch_installed_regex = (char *) GetConstraintValue("package_patch_installed_regex", pp, RVAL_TYPE_SCALAR);

    p.package_list_update_command = (char *) GetConstraintValue("package_list_update_command", pp, RVAL_TYPE_SCALAR);
    p.package_list_update_ifelapsed = GetIntConstraint("package_list_update_ifelapsed", pp);
    p.package_list_command = (char *) GetConstraintValue("package_list_command", pp, RVAL_TYPE_SCALAR);
    p.package_list_version_regex = (char *) GetConstraintValue("package_list_version_regex", pp, RVAL_TYPE_SCALAR);
    p.package_list_name_regex = (char *) GetConstraintValue("package_list_name_regex", pp, RVAL_TYPE_SCALAR);
    p.package_list_arch_regex = (char *) GetConstraintValue("package_list_arch_regex", pp, RVAL_TYPE_SCALAR);

    p.package_installed_regex = (char *) GetConstraintValue("package_installed_regex", pp, RVAL_TYPE_SCALAR);

    p.package_version_regex = (char *) GetConstraintValue("package_version_regex", pp, RVAL_TYPE_SCALAR);
    p.package_name_regex = (char *) GetConstraintValue("package_name_regex", pp, RVAL_TYPE_SCALAR);
    p.package_arch_regex = (char *) GetConstraintValue("package_arch_regex", pp, RVAL_TYPE_SCALAR);

    p.package_add_command = (char *) GetConstraintValue("package_add_command", pp, RVAL_TYPE_SCALAR);
    p.package_delete_command = (char *) GetConstraintValue("package_delete_command", pp, RVAL_TYPE_SCALAR);
    p.package_update_command = (char *) GetConstraintValue("package_update_command", pp, RVAL_TYPE_SCALAR);
    p.package_patch_command = (char *) GetConstraintValue("package_patch_command", pp, RVAL_TYPE_SCALAR);
    p.package_verify_command = (char *) GetConstraintValue("package_verify_command", pp, RVAL_TYPE_SCALAR);
    p.package_noverify_regex = (char *) GetConstraintValue("package_noverify_regex", pp, RVAL_TYPE_SCALAR);
    ...
    p.package_name_convention = (char *) GetConstraintValue("package_name_convention", pp, RVAL_TYPE_SCALAR);
    p.package_delete_convention = (char *) GetConstraintValue("package_delete_convention", pp, RVAL_TYPE_SCALAR);

    p.package_multiline_start = (char *) GetConstraintValue("package_multiline_start", pp, RVAL_TYPE_SCALAR);

    p.package_version_equal_command = GetConstraintValue("package_version_equal_command", pp, RVAL_TYPE_SCALAR);
    p.package_version_less_command = GetConstraintValue("package_version_less_command", pp, RVAL_TYPE_SCALAR);
...
ProcessSelect GetProcessFilterConstraints(const Promise *pp)
{
    ...
    value = (char *) GetConstraintValue("pid", pp, RVAL_TYPE_SCALAR);
    ...
    value = (char *) GetConstraintValue("ppid", pp, RVAL_TYPE_SCALAR);
    ...
    value = (char *) GetConstraintValue("pgid", pp, RVAL_TYPE_SCALAR);
    ...
    value = (char *) GetConstraintValue("rsize", pp, RVAL_TYPE_SCALAR);
    ...
    value = (char *) GetConstraintValue("vsize", pp, RVAL_TYPE_SCALAR);
    if (value)
    {
        entries++;
    }
    ...
    value = (char *) GetConstraintValue("ttime_range", pp, RVAL_TYPE_SCALAR);
    if (value)
    {
        entries++;
    }
    ...
    value = (char *) GetConstraintValue("stime_range", pp, RVAL_TYPE_SCALAR);
    if (value)
    {
        entries++;
    }
    ...
    p.status = (char *) GetConstraintValue("status", pp, RVAL_TYPE_SCALAR);
    p.command = (char *) GetConstraintValue("command", pp, RVAL_TYPE_SCALAR);
    p.tty = (char *) GetConstraintValue("tty", pp, RVAL_TYPE_SCALAR);

    value = (char *) GetConstraintValue("priority", pp, RVAL_TYPE_SCALAR);
    if (value)
    {
        entries++;
    }
    ...
    value = (char *) GetConstraintValue("threads", pp, RVAL_TYPE_SCALAR);
    if (value)
    {
        entries++;
    }
    ...
    if ((p.process_result = (char *) GetConstraintValue("process_result", pp, RVAL_TYPE_SCALAR)) == NULL)
    {
        if (entries)
        {
...
ProcessCount GetMatchesConstraints(const Promise *pp)
{
    ...
    value = (char *) GetConstraintValue("match_range", pp, RVAL_TYPE_SCALAR);
...
Attributes GetInsertionAttributes(const Promise *pp)
{
    ...
    attr.sourcetype = GetConstraintValue("insert_type", pp, RVAL_TYPE_SCALAR);
...
EditLocation GetLocationAttributes(const Promise *pp)
{
    ...
    e.line_matching = GetConstraintValue("select_line_matching", pp, RVAL_TYPE_SCALAR);

    value = GetConstraintValue("before_after", pp, RVAL_TYPE_SCALAR);
    ...
    e.first_last = GetConstraintValue("first_last", pp, RVAL_TYPE_SCALAR);
    return e;
}
...
EditXml GetXmlConstraints(const Promise *pp)
{
    ...
    x.havebuildxpath = ((x.build_xpath = GetConstraintValue("build_xpath", pp, RVAL_TYPE_SCALAR)) != NULL);
    x.haveselectxpath = ((x.select_xpath = GetConstraintValue("select_xpath", pp, RVAL_TYPE_SCALAR)) != NULL);
    x.haveattributevalue = ((x.attribute_value = GetConstraintValue("attribute_value", pp, RVAL_TYPE_SCALAR)) != NULL);
...
EditRegion GetRegionConstraints(const Promise *pp)
{
    ...
    e.select_start = GetConstraintValue("select_start", pp, RVAL_TYPE_SCALAR);
    e.select_end = GetConstraintValue("select_end", pp, RVAL_TYPE_SCALAR);
...
EditReplace GetReplaceConstraints(const Promise *pp)
{
    ...
    r.replace_value = GetConstraintValue("replace_value", pp, RVAL_TYPE_SCALAR);
    r.occurrences = GetConstraintValue("occurrences", pp, RVAL_TYPE_SCALAR);
...
EditColumn GetColumnConstraints(const Promise *pp)
{
    ...
    c.column_separator = GetConstraintValue("field_separator", pp, RVAL_TYPE_SCALAR);
    ...
    value = GetConstraintValue("value_separator", pp, RVAL_TYPE_SCALAR);
    ...
    c.column_value = GetConstraintValue("field_value", pp, RVAL_TYPE_SCALAR);
    c.column_operation = GetConstraintValue("field_operation", pp, RVAL_TYPE_SCALAR);
...
StorageMount GetMountConstraints(const Promise *pp)
{
    ...
    m.mount_type = GetConstraintValue("mount_type", pp, RVAL_TYPE_SCALAR);
    m.mount_source = GetConstraintValue("mount_source", pp, RVAL_TYPE_SCALAR);
    m.mount_server = GetConstraintValue("mount_server", pp, RVAL_TYPE_SCALAR);
...
StorageVolume GetVolumeConstraints(const Promise *pp)
{
    ...
    value = GetConstraintValue("freespace", pp, RVAL_TYPE_SCALAR);

    v.freespace = (long) Str2Int(value);
    value = GetConstraintValue("sensible_size", pp, RVAL_TYPE_SCALAR);
    v.sensible_size = (int) Str2Int(value);
    value = GetConstraintValue("sensible_count", pp, RVAL_TYPE_SCALAR);
...
TcpIp GetTCPIPAttributes(const Promise *pp)
{
    ...
    t.ipv4_address = GetConstraintValue("ipv4_address", pp, RVAL_TYPE_SCALAR);
    t.ipv4_netmask = GetConstraintValue("ipv4_netmask", pp, RVAL_TYPE_SCALAR);
...
Report GetReportConstraints(const Promise *pp)
{
 ...
 r.result = GetConstraintValue("bundle_return_value_index", pp, RVAL_TYPE_SCALAR);
    
    if (GetConstraintValue("lastseen", pp, RVAL_TYPE_SCALAR))
    {
        r.havelastseen = true;
    ...
    r.filename = (char *) GetConstraintValue("file_to_print", pp, RVAL_TYPE_SCALAR);
    ...
    r.friend_pattern = GetConstraintValue("friend_pattern", pp, RVAL_TYPE_SCALAR);

    r.to_file = GetConstraintValue("report_to_file", pp, RVAL_TYPE_SCALAR);
...
Measurement GetMeasurementConstraint(const Promise *pp)
{
    ...
    m.stream_type = GetConstraintValue("stream_type", pp, RVAL_TYPE_SCALAR);

    value = GetConstraintValue("data_type", pp, RVAL_TYPE_SCALAR);
    ...
    m.history_type = GetConstraintValue("history_type", pp, RVAL_TYPE_SCALAR);
    m.select_line_matching = GetConstraintValue("select_line_matching", pp, RVAL_TYPE_SCALAR);
    m.select_line_number = GetIntConstraint("select_line_number", pp);
    m.policy = MeasurePolicy2Value(GetConstraintValue("select_multiline_policy", pp, RVAL_TYPE_SCALAR));
    
    m.extraction_regex = GetConstraintValue("extraction_regex", pp, RVAL_TYPE_SCALAR);
    m.units = GetConstraintValue("units", pp, RVAL_TYPE_SCALAR);
...
Database GetDatabaseConstraints(const Promise *pp)
{
    ...
    d.db_server_owner = GetConstraintValue("db_server_owner", pp, RVAL_TYPE_SCALAR);
    d.db_server_password = GetConstraintValue("db_server_password", pp, RVAL_TYPE_SCALAR);
    d.db_server_host = GetConstraintValue("db_server_host", pp, RVAL_TYPE_SCALAR);
    d.db_connect_db = GetConstraintValue("db_server_connection_db", pp, RVAL_TYPE_SCALAR);
    d.type = GetConstraintValue("database_type", pp, RVAL_TYPE_SCALAR);
    d.server = GetConstraintValue("database_server", pp, RVAL_TYPE_SCALAR);
    d.columns = GetListConstraint("database_columns", pp);
    d.rows = GetListConstraint("database_rows", pp);
    d.operation = GetConstraintValue("database_operation", pp, RVAL_TYPE_SCALAR);
    d.exclude = GetListConstraint("registry_exclude", pp);

    value = GetConstraintValue("db_server_type", pp, RVAL_TYPE_SCALAR);
