...
int IsItemInRegion(EvalContext *ctx, const char *item, const Item *begin, const Item *end, Rlist *insert_match, const Promise *pp);
void PrependItemList(Item **liststart, const char *itemstring);
int SelectItemMatching(EvalContext *ctx, Item *s, char *regex, Item *begin, Item *end, Item **match, Item **prev, char *fl);
...
int NeighbourItemMatches(EvalContext *ctx, const Item *start, const Item *location, const char *string, EditOrder pos, Rlist *insert_match, const Promise *pp);
...
int DeleteItemGeneral(EvalContext *ctx, Item **filestart, const char *string, ItemMatchType type);
int DeleteItemLiteral(EvalContext *ctx, Item **filestart, const char *string);
int DeleteItemStarting(EvalContext *ctx, Item **list, const char *string);
int DeleteItemNotStarting(EvalContext *ctx, Item **list, const char *string);
int DeleteItemMatching(EvalContext *ctx, Item **list, const char *string);
int DeleteItemNotMatching(EvalContext *ctx, Item **list, const char *string);
int DeleteItemContaining(EvalContext *ctx, Item **list, const char *string);
int DeleteItemNotContaining(EvalContext *ctx, Item **list, const char *string);
